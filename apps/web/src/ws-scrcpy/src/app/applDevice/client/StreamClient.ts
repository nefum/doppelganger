...
export abstract class StreamClient<T extends ParamsStream> extends BaseClient<
  T,
  StreamClientEvents
> {
  public static ACTION = "MUST_OVERRIDE";
  protected static players: Map<string, PlayerClass> = new Map<
    string,
    PlayerClass
  >();
  ...
  protected constructor(params: T) {
    ...
    this.wdaProxy = new WdaProxyClient({
      ...this.params,
  ...
  protected startStream(inputPlayer?: BasePlayer): void {
    ...
    const applToolBox = ApplToolBox.createToolBox(
      udid,
      player,
      this,
      this.wdaProxy,
