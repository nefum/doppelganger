...
import {
  DefaultMjpegServerOption,
  MjpegServerOptions,
  WdaProxyClient,
} from "../client/WdaProxyClient";
...
export class ApplMjpegMoreBox extends ApplMoreBox {
  ...
  constructor(udid: string, player: BasePlayer, wdaConnection: WdaProxyClient) {
    ...
    const scalingWrapper = ApplMjpegMoreBox.wrap(
      "div",
      [scalingFactorLabel, scalingFactorInput],
      innerDiv,
    );
    ...
    btn.onclick = () => {
      ...
      const mjpegServerScreenshotQuality = parseInt(
