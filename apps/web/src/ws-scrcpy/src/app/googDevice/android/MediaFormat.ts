export default class MediaFormat {
  ...
  public static readonly MIMETYPE_VIDEO_DOLBY_VISION: string =
    "video/dolby-vision";
   ...
   */
  public static readonly MIMETYPE_IMAGE_ANDROID_HEIC: string =
   ...
   * The associated value is an integer.
   */
  public static readonly KEY_INTRA_REFRESH_PERIOD: string =
   ...
   */
  public static readonly KEY_PREPEND_HEADER_TO_SYNC_FRAMES: string =
   ...
   */
  public static readonly KEY_REPEAT_PREVIOUS_FRAME_AFTER: string =
   ...
   *
   */
  public static readonly KEY_MAX_PTS_GAP_TO_ENCODER: string =
   ...
   */
  public static readonly KEY_CREATE_INPUT_SURFACE_SUSPENDED: string =
   ...
   */
  public static readonly KEY_PUSH_BLANK_BUFFERS_ON_STOP: string =
   ...
   */
  public static readonly KEY_AAC_MAX_OUTPUT_CHANNEL_COUNT: string =
   ...
   * <p>This key is only used during decoding.
   */
  public static readonly KEY_AAC_DRC_TARGET_REFERENCE_LEVEL: string =
   ...
   * <p>This key is only used during decoding.
   */
  public static readonly KEY_AAC_DRC_EFFECT_TYPE: string =
    "aac-drc-effect-type";
   ...
   * <p>This key is only used during decoding.
   */
  public static readonly KEY_AAC_ENCODED_TARGET_LEVEL: string =
    "aac-encoded-target-level";
   ...
   * <p>This key is only used during decoding.
   */
  public static readonly KEY_AAC_DRC_BOOST_FACTOR: string =
    "aac-drc-boost-level";
   ...
   * <p>This key is only used during decoding.
   */
  public static readonly KEY_AAC_DRC_ATTENUATION_FACTOR: string =
    "aac-drc-cut-level";
   ...
   * <p>This key is only used during decoding.
   */
  public static readonly KEY_AAC_DRC_HEAVY_COMPRESSION: string =
   ...
   */
  public static readonly KEY_FLAC_COMPRESSION_LEVEL: string =
   ...
   */
  public static readonly KEY_OUTPUT_REORDER_DEPTH: string =
    "output-reorder-depth";
   ...
   * The associated value is an integer.
   */
  public static readonly KEY_HAPTIC_CHANNEL_COUNT: string =
