...
export abstract class BaseDeviceTracker<
  DD extends BaseDeviceDescriptor,
  TE extends EventMap,
> extends ManagerClient<ParamsDeviceTracker, TE> {
  ...
  public static readonly AttributePrefixInterfaceSelectFor =
    "interface_select_for_";
  ...
  private getOrCreateTrackerBlock(
    parent: Element,
