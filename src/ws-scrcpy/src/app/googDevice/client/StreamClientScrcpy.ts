    ...
    implements KeyEventListener, InteractionHandlerListener
{
    ...
    public static start(
        ...
        if (query instanceof URLSearchParams) {
            ...
            return new StreamClientScrcpy(params, deviceView, streamReceiver, player, fitToScreen, videoSettings);
        } else {
            return new StreamClientScrcpy(query, deviceView, streamReceiver, player, fitToScreen, videoSettings);
        }
    }
    ...
    public startStream({ udid, player, playerName, videoSettings, fitToScreen }: StartParams): void {
        ...
        const deviceView = this.deviceView;
